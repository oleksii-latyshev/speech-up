...
export const SCENARIOS: Scenario[] = [
  {
    id: "interview",
    title: "Job Interview",
    description: "A realistic interview — one question at a time, with follow-ups. Pick your track:",
    icon: Briefcase,
  ...
  },
  {
    id: "standup",
    title: "Daily Standup",
    description: "Yesterday, today, blockers — report to a teammate who asks real follow-ups.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Debate architecture, tools and trade-offs with a peer who challenges your reasoning.",
    icon: MessagesSquare,
  ...
  },
  {
    ...
    description: "Relaxed small talk — weekends, travel, movies, life. No pressure, just flow.",
    icon: Coffee,
